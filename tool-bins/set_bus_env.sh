...
export FABRIC_CFG_PATH=/workspaces/universityconsortium/config/bus
# Address of the peer
export CORE_PEER_ADDRESS=bus.privateuni.edu:7051
# Local MSP for the admin - Commands need to be executed as org admin
export CORE_PEER_MSPCONFIGPATH=/workspaces/universityconsortium/config/crypto-config/peerOrganizations/privateuni.edu/users/Admin@privateuni.edu/msp

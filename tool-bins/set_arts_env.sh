...
export FABRIC_CFG_PATH=/workspaces/universityconsortium/config/arts
# Address of the peer
export CORE_PEER_ADDRESS=arts.interuni.edu:7051
# Local MSP for the admin - Commands need to be executed as org admin
export CORE_PEER_MSPCONFIGPATH=/workspaces/universityconsortium/config/crypto-config/peerOrganizations/interuni.edu/users/Admin@interuni.edu/msp

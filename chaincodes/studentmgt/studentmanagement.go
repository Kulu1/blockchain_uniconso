...
func (s *StudentContract) CreateStudent(ctx contractapi.TransactionContextInterface, id string, name string, dateOfBirth time.Time, gender string, graduationStatus bool) error {
...
func (s *StudentContract) UpdateStudent(ctx contractapi.TransactionContextInterface, id string, name string, dateOfBirth time.Time, gender string, graduationStatus bool) error {
